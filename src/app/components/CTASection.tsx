      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link to="/contato">
              <motion.div
                className="group inline-flex items-center gap-3 bg-[#F8FAF7] hover:bg-white text-[#2D4A2D] px-10 py-5 rounded-full transition-all duration-500 shadow-xl hover:shadow-2xl hover:scale-105 backdrop-blur-sm cursor-pointer"
            ...
            <Link to="/contato">
              <motion.div
                className="group inline-flex items-center gap-3 bg-white/10 hover:bg-white/20 text-[#F8FAF7] px-10 py-5 rounded-full border-2 border-white/30 hover:border-white/60 transition-all duration-500 backdrop-blur-md cursor-pointer"
                style={{ fontFamily: 'var(--font-body)', fontWeight: 500 }}
                whileHover={{ y: -4 }}
                whileTap={{ scale: 0.98 }}
              >
